  ...
  return (
    ...
    className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            <img src={assets.email_icon} alt=""  width={23}/>
            <input onChange={e => setEmail(e.target.value)} value = {email} type="email" className='ml-1.5 outline-none text-sm' placeholder='E-mail Id' required />
        </div>

        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            <img src={assets.lock_icon} alt=""  width={18}/>
            <input onChange={e => setPassword(e.target.value)} value = {password} type="password" className='ml-2 outline-none text-sm' placeholder='Password' required />
        </div>
        ...
        className='absolute top-5 right-5 cursor-poionter'/>
    </motion.form>
